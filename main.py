...
import uvicorn
from Funciones import cantidad_filmaciones_mes, cantidad_filmaciones_dia, score_titulo, votos_titulo, get_actor, get_director, recommend_movies
...
async def score(titulo_de_la_filmacion:str):
...
async def votos(titulo_de_la_filmacion):
...
async def director(nombre_director):
...
async def sistem_recommend_movies(title):
